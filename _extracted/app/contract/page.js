...
export default function Page() {
    ...
    const handleDownloadPDF = () => {
        ...
        const opt = {
            ...
            filename: 'Contract-20250314-CON-01-GSEEduConsult.pdf',
        ...
        <div>
            ...
            <div >
                <div ref={invoiceRef} className="max-w-3xl mx-auto bg-primary/2 p-8 rounded-lg shadow-lg">
                    <p className='text-xs my-2'>SAH-CON-2025-MA1403-xb8e4f2a1c3d9e7f5-1710423612@saharabasetech.com</p>
                    ...
                    <div className="flex bg-primary/10 rounded-lg p-4  justify-between items-start mb-8">
                        ...
                        <div className="text-right mt-16">
                            ...
                            <p className="text-gray-600 text-sm">Date: Mar 14, 2025</p>
                            <p className='text-gray-600 text-sm'>Document ID: SAH-ADM-20250314-CON-21</p>
                    ...
                    <div className='fle items-start justify-between'>
                        ...
                        <h1 className='font-bold text-5xl mt-8'>Education <br /> Consultancy <br />Website Agreement</h1>
                        <p className='my-8 text-gray-600 text-sm'>SAHARA BASE TECHNOLOGIES | GSE EDU CONSULT</p>

                        {/* Bill To Section */}
                        <div className="mb-8 mt-80">
                            <h3 className="text-gray-600 font-semibold mb-2 ">Prepared For</h3>
                            <p className="text-gray-800 font-semibold">GSE Edu Consult</p>
                            {/* <p className="text-gray-600 text-sm">+233 54 531 8356</p> */}
                            <p className="text-gray-600 text-sm">Accra, Ghana</p>

                            <p className="text-gray-600 my- text-sm">Contact Ref: +233 55 466 8284</p>
                    ...
                    <div className="mb-8 mt-">
                        ...
                        <p className='text-gray-600 text-sm'>This scope of work details the specific deliverables, technical requirements, and project dependencies. The successful completion of this project relies on close collaboration between Sahara and GSE Edu Consult, particularly regarding content provision and design approval processes.</p>


                        <p className='text-gray-600 my-2 text-sm font-semibold'>1. Domain & Hosting Services</p>
                        <ul className='ml-2'>
                            <li className='text-gray-600 text-sm my-1'>• Domain name registration for gseduconsult.com (first year included)</li>
                            <li className='text-gray-600 text-sm my-1'>• Web hosting setup and configuration for one year</li>
                            <li className='text-gray-600 text-sm my-1'>• Setup of up to 25 professional email accounts</li>
                            <li className='text-gray-600 text-sm my-1'>• DNS management and configuration</li>
                        </ul>

                        <p className='text-gray-600 my-2 text-sm font-semibold'>2. Website & Platform Development</p>
                        <ul className='ml-2'>
                            <p className='text-sm text-gray-600'>A. Core Website Components</p>
                            <li className='text-gray-600 text-sm my-1'>• Complete admin dashboard for applicant management and tracking</li>
                            <li className='text-gray-600 text-sm my-1'>• Integrated e-commerce shop for guides and courses</li>
                            {/* <li className='text-gray-600 text-sm my-1'>• Professional blog system with SEO features</li> */}
                            <li className='text-gray-600 text-sm my-1'>• Contact forms and communication tools</li>
                            {/* <li className='text-gray-600 text-sm my-1'>• Smart data collection forms for student inquiries</li> */}
                            <li className='text-gray-600 text-sm my-1'>• Testimonial management system with approval workflow</li>
                            <li className='text-gray-600 text-sm my-1'>• Content management system for self-service updates</li>
                            <li className='text-gray-600 text-sm my-1'>• Social media integration</li>
                            <li className='text-gray-600 text-sm my-1'>• Fully responsive design for all devices</li>
                            <li className='text-gray-600 text-sm my-1'>• SEO optimization</li>
                        </ul>

                        <ul className='ml-2 mt-6'>
                            <p className='text-sm text-gray-600'>B. Technical Support & Maintenance</p>
                            <li className='text-gray-600 text-sm my-1'>• One full year of technical support included</li>
                            <li className='text-gray-600 text-sm my-1'>• Security monitoring and updates</li>
                            <li className='text-gray-600 text-sm my-1'>• Performance optimization</li>
                            <li className='text-gray-600 text-sm my-1'>• Bug fixes and system updates</li>
                            <li className='text-gray-600 text-sm my-1'>• Technical documentation and training</li>
                        </ul>
                    ...
                    <div className="mb-8 mt-">
                        ...
                        <p className='text-gray-600 text-sm'>The developer shall provide website hosting services for the Client's website once development is complete. Hosting shall be on a secure server environment with a minimum of 99.9% server uptime.
                            ...
                            The Developer agrees to provide reasonable access to any parties authorized by the Client for purposes of website audits, updates, or modifications. <br /><br />

                            The hosting service is included for the first year from launch date, after which the client will be required to pay an annual hosting fee of $50.00 USD to maintain the service.
                    ...
                    <div className="mb-8 mt-">
                        ...
                        <p className='text-gray-600 text-sm'>The Developer agrees to attain design approval from the Client prior to the Developer beginning development by submitting detailed design mockups for the Client's review.
                            ...
                            <ul className='ml-4 text-sm text-gray-600'>
                                <li>1. Any destructive, crude, insulting, harassing, violent, sexual or any other inappropriate content
                                </li>
                    ...
                    <div className="mb-8 mt-">
                        ...
                        <p className='text-gray-600 text-sm'>The total cost for all services outlined in this scope of work is. This comprehensive pricing was agreed upon during consultation between the parties and covers all deliverables detailed in this document. A complete cost breakdown can be found in Invoice #MA1403, dated March 14, 2025, which has been provided to GSE Edu Consult and is incorporated here by reference.
                            ...
                            <br /><br />
                            <ul className='ml-4 text-sm text-gray-600'>
                                <li>1. 60% deposit is required before work commences</li>
                                <li>2. Remaining balance due upon completion of work </li>
                                <li>3. Payment method: Mobile Money (Details as specified in Invoice #MA1403) </li>
                                {/* <li>4. Exchange rate: GH₵[CURRENT RATE] to USD (as of invoice date)</li> */}
                            </ul>
                    ...
                    <div className="mb-8 mt-">
                        ...
                        <p className='text-gray-600 text-sm'>This agreement represents the entire scope of work between Sahara and GSE Edu Consult for the website development project described herein. By signing below, both parties acknowledge that they have read, understood, and agree to all terms and conditions outlined in this document, including the payment terms, deliverables, and project timeline. Any modifications to this agreement must be made in writing and signed by both parties.
                        ...
                        <div className='bg-gray-100 w-full p-4 my-4 flex items-start justify-between'>
                            ...
                            <div className='text-right'>
                                <p className='font-bold mb-8'>GSE Edu Consult</p>
                                <span className=''>_____________________________________</span>
                                <p className='text-sm  mt-4'>GSE Edu Consult Rep</p>
                    ...
                    <div className="flex justify-between items-center pt-6 mt-6 border-t border-gray-300">
                        ...
                        <div className="text-xs text-gray-500">
                            <p>Document ID: SAH-ADM-20250314-CON-01</p>
                            <p>Generated on System: SAH-ERP-DOC-2025</p>
                            <p>Timestamp: 2025-03-14T05:13:12Z</p>
                            <p>Reference Invoice: MA1403</p>
                        </div>
                    </div>
                </div>
            </div>
